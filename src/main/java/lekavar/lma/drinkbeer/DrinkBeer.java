...
public class DrinkBeer implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        //Mixed beer
        MIXED_BEER_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, "drinkbeer:mixed_beer_entity", BlockEntityType.Builder.create(MixedBeerEntity::new, MIXED_BEER).build(null));
        ...
        //Bartending table
        BARTENDING_TABLE_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, "drinkbeer:bartending_table_entity", BlockEntityType.Builder.create(BartendingTableEntity::new, BARTENDING_TABLE_NORMAL).build(null));
        ...
        //Trade box
        TRADE_BOX_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, "drinkbeer:trade_box_entity", BlockEntityType.Builder.create(TradeboxEntity::new, TRADE_BOX_NORMAL).build(null));
